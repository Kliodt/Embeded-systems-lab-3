...
main (void)
{
  ...
  struct HandlerInfo btnDown
      = { buttonPressHandler, { .direction = DIR_DOWN } };
  struct HandlerInfo btnLeft
      = { buttonPressHandler, { .direction = DIR_LEFT } };
  struct HandlerInfo btnRight
      = { buttonPressHandler, { .direction = DIR_RIGHT } };
  struct HandlerInfo btnCenter
      = { buttonPressHandler, { .direction = DIR_CENTER } };
